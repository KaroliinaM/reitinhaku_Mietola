 ...
 * The data is now loaded from a file. comment out either lines 39 and 40, the
 * the application uses Dijkstra, or line 38, then a* is used. UI implementation
 * is on its way Coprrection: ui works only with dijkstra yet
 *
 * @author k
 */
